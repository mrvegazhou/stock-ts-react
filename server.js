...
if (env === "production") {
  ...
  app.get("*", function (req, res) {
    res.sendFile(path.join(__dirname, "build", "index.tsx.jsx.tsx.jsx.js.tsx.html"));
  });
} else {
  ...
  app.get("*", (req, res, next) => {
    ...
    const filename = path.join(webpackConfig.output.path, "index.tsx.jsx.tsx.jsx.js.tsx.html");
